...
function getClueForWord(word: string, category: Category): string {
  const clues: Record<Category, Record<string, string>> = {
    lugares: {
      ...
      'Volcán': 'Fuego', 'Río': 'Fluir', 'Cascada': 'Caída', 'Lago': 'Calma', 'Selva': 'Vida', 'Valle': 'Entre', 
      'Cueva': 'Oscuro', 'Pantano': 'Lodo', 'Cañón': 'Grieta', 'Arrecife': 'Coral',
      ...
      'Canadá': 'Arce', 'Japón': 'Tradición', 'China': 'Dragón', 'India': 'Especias', 'Australia': 'Canguros', 
      'Alemania': 'Cerveza', 'Inglaterra': 'Real', 'Rusia': 'Frío', 'Corea': 'Kpop', 'Egipto': 'Faraones',
    ...
    comida: {
      ...
      'Picadillo': 'Verdura', 'Arroz Pollo': 'Amarillo', 'Pozol': 'Bebida', 'Sopa Negra': 'Negro', 'Enyucados': 'Yuca', 
      'Prestiños': 'Miel', 'Cajetas': 'Coco', 'Melcochas': 'Pegajoso', 'Churchill': 'Raspado', 'Granizado': 'Hielo',
      ...
      'Hot Dog': 'Salchicha', 'Sandwich': 'Rebanadas', 'Papas Fritas': 'Dorada', 'Pollo Frito': 'Crujiente', 
      'Carne Asada': 'Parrilla', 'Costillas': 'Hueso', 'Alitas': 'Picante', 'Nachos': 'Totopos', 'Quesadilla': 'Derretida', 
      'Enchiladas': 'Salsa',
      ...
      'Panqueques': 'Esponjosa', 'Donas': 'Anillo', 'Galletas': 'Crujiente', 'Pastel': 'Celebración', 'Pie': 'Tarta', 
      'Muffins': 'Panecillo', 'Tiramisú': 'Café', 'Cheesecake': 'Queso', 'Macarrones': 'Galleta', 'Éclair': 'Alargado',
      ...
      'Fresco': 'Refrescante', 'Agua Dulce': 'Azúcar', 'Pinolillo': 'Tostado', 'Imperial': 'Cerveza', 'Cerveza': 'Lúpulo', 
      'Vino': 'Uva', 'Limonada': 'Ácido', 'Naranjada': 'Cítrico', 'Pipas': 'Coco', 'Copo': 'Nieve'
    },
    objetos: {
      ...
      'Billetera': 'Dinero', 'Cartera': 'Bolso', 'Cinturón': 'Sostener', 'Collar': 'Adorno', 'Anillo': 'Joya', 
      'Pulsera': 'Muñeca', 'Aretes': 'Orejas', 'Bufanda': 'Abrigo', 'Sombrero': 'Cabeza', 'Camisa': 'Torso',
      ...
      'Borrador': 'Eliminar', 'Engrapadora': 'Unir', 'Perforadora': 'Huecos', 'Crayones': 'Cera', 'Acuarelas': 'Agua', 
      'Pincel': 'Pintura', 'Compás': 'Círculo', 'Cartuchera': 'Guardar', 'Folder': 'Carpeta', 'Resaltador': 'Marca',
      ...
      'Colchón': 'Base', 'Closet': 'Armario', 'Cajonera': 'Cajones', 'Librero': 'Libros', 'Mecedora': 'Balanceo', 
      'Televisor': 'Pantalla', 'Ventilador': 'Aire', 'Cortinas': 'Ventana', 'Alfombra': 'Piso', 'Cuadro': 'Arte',
      ...
      'Licuadora': 'Mezclar', 'Horno': 'Calor', 'Cafetera': 'Bebida', 'Tostadora': 'Pan', 'Batidora': 'Ingredientes', 
      'Exprimidor': 'Jugo', 'Escurridor': 'Agua', 'Tabla Cortar': 'Picar', 'Colador': 'Separar', 'Tetera': 'Hervir',
      ...
      'Tenis': 'Deportivo', 'Botas': 'Alto', 'Sandalias': 'Abierto', 'Pantuflas': 'Casa', 'Traje Baño': 'Playa', 
      'Toalla': 'Secar', 'Cepillo': 'Limpia', 'Peine': 'Ordena', 'Secadora': 'Seca', 'Plancha': 'Arrugas'
    },
    animales: {
      ...
      'Cerdo': 'Rosado', 'Gallina': 'Corral', 'Oveja': 'Lana', 'Cabra': 'Todo', 'Burro': 'Carga', 'Pato': 'Graznido', 
      'Ganso': 'Grande', 'Pavo': 'Thanksgiving', 'Loro': 'Habla', 'Canario': 'Canta',
      ...
      'Oso': 'Peludo', 'Lobo': 'Aullido', 'Zorro': 'Astuto', 'Leopardo': 'Manchas', 'Pantera': 'Oscuro', 
      'Guepardo': 'Veloz', 'Gorila': 'Fuerte', 'Orangután': 'Naranja', 'Lémur': 'Ojos', 'Koala': 'Eucalipto',
      ...
      'Morsa': 'Colmillos', 'Mantarraya': 'Volar', 'Langosta': 'Pinzas', 'Cangrejo': 'Lado', 'Camarón': 'Comestible', 
      'Almeja': 'Perla', 'Coral': 'Colorido', 'Atún': 'Grande', 'Salmón': 'Río', 'Anguila': 'Serpiente',
      ...
      'Halcón': 'Cazador', 'Cuervo': 'Inteligente', 'Pavo Real': 'Plumas', 'Avestruz': 'Correr', 'Cigüeña': 'Patas', 
      'Paloma': 'Urbana', 'Gorrión': 'Pequeña', 'Perezoso': 'Lento', 'Jaguar': 'Manchas', 'Puma': 'Montaña',
      ...
      'Mosca': 'Molesta', 'Avispa': 'Agresiva', 'Cucaracha': 'Resistente', 'Luciérnaga': 'Brillo', 'Caracol': 'Concha', 
      'Lombriz': 'Tierra', 'Rana': 'Verde', 'Sapo': 'Verrugas', 'Serpiente': 'Largo', 'Lagartija': 'Cola'
    },
    cantantes: {
      ...
      'Rauw Alejandro': 'Todo', 'Myke Towers': 'Dinero', 'Jhay Cortez': 'Oscuro', 'Sech': 'Viral', 'Farruko': 'Pepas',
      'Taylor Swift': 'Eras', 'Drake': 'Toronto', 'Ariana Grande': 'Poderosa', 'Ed Sheeran': 'Pelirrojo', 'Billie Eilish': 'Susurro', 
      'The Weeknd': 'Única', 'Dua Lipa': 'Disco', 'Harry Styles': 'Banda', 'Bruno Mars': 'Funk', 'Post Malone': 'Tatuado',
      'Travis Scott': 'Autotune', 'Eminem': 'Blanco', 'Kanye West': 'Controversial', 'Kendrick Lamar': 'Consciente', 'SZA': 'Suave',
      'Beyoncé': 'Reina', 'Rihanna': 'Belleza', 'Adele': 'Alma', 'Coldplay': 'Británica', 'Maroon 5': 'Rock', 
      'Katy Perry': 'Alegre', 'Lady Gaga': 'Talento', 'Justin Bieber': 'Joven', 'Shawn Mendes': 'Guitarrista', 'Camila Cabello': 'Dulce',
      'Miley Cyrus': 'Disney', 'Selena Gomez': 'Actriz', 'Demi Lovato': 'Fuerte', 'The Chainsmokers': 'Electrónico', 'Marshmello': 'Máscara',
      ...
      'Reik': 'Trío', 'Sin Bandera': 'Dúo', 'Camilo': 'Rizado', 'Manuel Turizo': 'Lady', 'Grupo Frontera': 'Regional',
      ...
      'Romeo Santos': 'Bachata', 'Prince Royce': 'Joven', 'Aventura': 'Grupo', 'Don Omar': 'Rey', 'Tego Calderón': 'Rapero'
    },
    deportes: {
      ...
      'Rugby': 'Oval', 'Hockey': 'Palo', 'Surf': 'Ola', 'Skate': 'Tabla', 'Karate': 'Arte', 'Taekwondo': 'Patada', 
      'Judo': 'Caída', 'Esgrima': 'Espada', 'Gimnasia': 'Flexibilidad', 'Polo': 'Caballo',
      ...
      'Vinicius Jr': 'Regate', 'Pedri': 'Joven', 'Gavi': 'Cantera', 'Bellingham': 'Promesa', 'Kane': 'Capitán',
      ...
      'Luka Doncic': 'Talento', 'Ja Morant': 'Explosivo', 'Jayson Tatum': 'Versátil', 'Damian Lillard': 'Tiempo', 'Anthony Davis': 'Ceja',
      ...
      'Venus Williams': 'Hermana', 'Simona Halep': 'Rápida', 'Stefanos Tsitsipas': 'Griego', 'Alexander Zverev': 'Alto', 'Casper Ruud': 'Arcilla',
      ...
      'Muhammad Ali': 'Grande', 'Mike Tyson': 'Demoledor', 'Nadia Comaneci': 'Perfección', 'Carl Lewis': 'Saltador'
    }
  };
